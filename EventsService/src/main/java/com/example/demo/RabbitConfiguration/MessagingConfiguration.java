...
public class MessagingConfiguration {
    ...
    public final static String QUEUE="eventservice_queue";
    public final static String EXCHANGE="eventservice_exchange";
    public final static String KEY="eventservice_key";
